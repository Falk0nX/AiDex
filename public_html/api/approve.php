...
try {
  ...
  $ins->execute([':name'=>$sub['name'],':website_url'=>$sub['website_url'],':description'=>$sub['description'],':category'=>$sub['category'],':pricing'=>$sub['pricing'],':tags'=>$sub['tags'],':is_open_source'=>(int)$sub['is_open_source'],':source_submission_id'=>$id]);
